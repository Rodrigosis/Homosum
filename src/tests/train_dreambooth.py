...
def rodrigo(
        ...
        save_sample_prompt: Optional[str] = None,
        save_sample_negative_prompt: Optional[str] = None,
        n_save_sample: Optional[int] = 4,
        save_guidance_scale: Optional[float] = 7.5,
        save_infer_steps: Optional[int] = 20,
        pad_tokens: Optional[bool] = False,
        with_prior_preservation: Optional[bool] = False,
        ):
...
def parse_args(input_args=None):
    ...
    parser.add_argument(
        ...
        type=int,
        default=100,
        help=("Minimal class images for prior preservation loss. If not have enough images, additional images will be sampled with class_prompt."),
    )
    parser.add_argument(
        "--output_dir",
        type=str,
...
def main(
        ...
        save_min_steps: Optional[int] = 0,
        mixed_precision: Optional[str] = None,  # choices=["no", "fp16", "bf16"]
        not_cache_latents: Optional[bool] = False,
        hflip: Optional[bool] = False,
        local_rank: Optional[int] = -1,
        concepts_list: Optional[str] = None,
        read_prompts_from_txts: Optional[bool] = False,
        ):
