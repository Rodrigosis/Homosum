            ...
            if opt.no_base_name:
                ...
                if opt.legacy_naming:
                    ...
                    cfg_path = os.path.split(opt.base[0])[0].split(os.sep)[
                        # rodrigo edit - old - os.path.split(opt.base[0])[0].split(os.sep).index("configs")
                        # rodrigo edit - new - os.path.split(opt.base[0])[0].split('/').index("configs")
                        os.path.split(opt.base[0])[0].split('/').index("configs")
                        + 1 :
